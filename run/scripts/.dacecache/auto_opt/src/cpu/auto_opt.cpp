    ...
    for (k = (K - 1); (k <= (K - 1)); k = k + 1) {
        {
            ...
            __tmp85, dcol + ((((J * K) * __i0) + (K * __i1)) + k), 1);
...

            {
                ...
                for (auto __i0 = 0; __i0 < I; __i0 += 1) {
                    for (auto __i1 = 0; __i1 < J; __i1 += 1) {
                        ...
                        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                        __tmp70, __state->__0_cs + ((J * __i0) + __i1), 1);
                        {
                        ...
                        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                        __tmp74, __state->__0_dcol + ((((J * K) * __i0) + (K * __i1)) + k), 1);
                        {
                            double __in2 = __tmp73[0];
                            double __in1 = __tmp74[0];
                            double __out;
...

            {
                ...
                for (auto __i0 = 0; __i0 < I; __i0 += 1) {
                    for (auto __i1 = 0; __i1 < J; __i1 += 1) {
                        ...
                        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                        __tmp79, __state->__0_ccol + ((((J * K) * __i0) + (K * __i1)) + k), 1);
                        {
                            const double __in1 = __s5_n28__out_n29IN___tmp26;
                            double __in2 = __tmp79[0];
                            double __out;
            ...
            }
            {
                ...
                for (auto __i0 = 0; __i0 < I; __i0 += 1) {
                    for (auto __i1 = 0; __i1 < J; __i1 += 1) {
                        ...
                        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                        __tmp81, __state->__0_dcol + ((((J * K) * __i0) + (K * __i1)) + k), 1);
