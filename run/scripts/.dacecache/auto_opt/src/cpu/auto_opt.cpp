...
inline void nested_BinOp_65_0_7_11(auto_opt_t *__state, double* __restrict__ ccol, const double&  dtr_stage, double* __restrict__ u_pos, double* __restrict__ u_stage, double* __restrict__ utens, double* __restrict__ utens_stage, double* __restrict__ wcon, double* __restrict__ dcol, long long I, long long J, long long K, long long __i0, long long __i1) {
    long long k;




    for (k = (K - 1); (k <= (K - 1)); k = k + 1) {
        {
            ...
            __tmp89, dcol + ((((J * K) * __i0) + (K * __i1)) + k), 1);
...
void __program_auto_opt_internal(auto_opt_t *__state, double * __restrict__ u_pos, double * __restrict__ u_stage, double * __restrict__ utens, double * __restrict__ utens_stage, double * __restrict__ wcon, long long I, long long J, long long K, double dtr_stage)
{
...

            {
                ...
                for (auto __i0 = 0; __i0 < I; __i0 += 1) {
                    for (auto __i1 = 0; __i1 < J; __i1 += 1) {
                        ...
                        double __tmp90[1]  DACE_ALIGN(64);
                        double __tmp91[1]  DACE_ALIGN(64);
                        ...
                        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                        __tmp90, __state->__0_bcol + ((J * __i0) + __i1), 1);
                        {
                            double __in2 = __tmp90[0];
                            double __out;
                        ...
                        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                        __tmp91, __state->__0_ccol + ((((J * K) * __i0) + (K * __i1)) + k), 1);
                        {
                            double __in2 = __tmp74[0];
                            double __in1 = __tmp91[0];
                            double __out;
                        ...
                        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                        __tmp73, __state->__0_dcol + ((((J * K) * __i0) + (K * __i1)) + k), 1);
                        {
                            double __in1 = __tmp73[0];
                            double __in2 = __tmp74[0];
                            double __out;
                            ...
                            __state->__0_dcol[((((J * K) * __i0) + (K * __i1)) + k)] = __out;
                        }
                    }
                }
            }
...

            {
                ...
                for (auto __i0 = 0; __i0 < I; __i0 += 1) {
                    for (auto __i1 = 0; __i1 < J; __i1 += 1) {
                        ...
                        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                        __tmp76, __state->__0_acol + ((J * __i0) + __i1), 1);
                        double __s5_n28__out_n29IN___tmp26;
                        {
                            double __in1 = dtr_stage;
                            double __in2 = __tmp76[0];
                            double __out;
                        ...
                        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                        __tmp75, __state->__0_ccol + ((((J * K) * __i0) + (K * __i1)) + k), 1);
                        {
            ...
            }
            {
                ...
                for (auto __i0 = 0; __i0 < I; __i0 += 1) {
                    for (auto __i1 = 0; __i1 < J; __i1 += 1) {
                        ...
                        dace::CopyND<double, 1, false, 1>::template ConstDst<1>::Copy(
                        __tmp80, __state->__0_dcol + ((((J * K) * __i0) + (K * __i1)) + k), 1);
                        ...
                        {
                            double __in2 = __state->__0_acol[((J * __i0) + __i1)];
                            double __in1 = __state->__0_dcol[(((((J * K) * __i0) + (K * __i1)) + k) - 1)];
                            double __out;
...

    {

        {
            ...
            for (auto __i0 = 0; __i0 < I; __i0 += 1) {
                for (auto __i1 = 0; __i1 < J; __i1 += 1) {
                    nested_BinOp_65_0_7_11(__state, &__state->__0_ccol[0], dtr_stage, &u_pos[0], &u_stage[0], &utens[0], &utens_stage[0], &wcon[0], &__state->__0_dcol[0], I, J, K, __i0, __i1);
                }
            }
        }
    ...
    for (k = (K - 1); (k > (K - 2)); k = (k + (- 1))) {
        {
            double* __tmp1_5;
            __tmp1_5 = &__state->__0_dcol[k];
            double* datacol;
            datacol = &__tmp1_5[0];


            dace::CopyNDDynamic<double, 1, false, 2>::Dynamic::Copy(
            datacol, __state->__0_data_col, I, (J * K), J, J, K, 1);
        ...
        }
        {
...

            {
                ...
                for (auto __i0 = 0; __i0 < I; __i0 += 1) {
                    for (auto __i1 = 0; __i1 < J; __i1 += 1) {
                        double __s13_n1__out_n2IN___tmp63;
                        {
                            double __in1 = datacol[(((J * K) * __i0) + (K * __i1))];
                            double __in2 = u_pos[((((J * K) * __i0) + (K * __i1)) + k)];
                            double __out;
                            ...
                            __s13_n1__out_n2IN___tmp63 = __out;
                        }
                        {
                            const double __in2 = __s13_n1__out_n2IN___tmp63;
                            double __in1 = dtr_stage;
                            double __out;
    ...
    for (k = (K - 2); (k > (- 1)); k = (k + (- 1))) {
        {

            {
                ...
                for (auto __i0 = 0; __i0 < I; __i0 += 1) {
                    for (auto __i1 = 0; __i1 < J; __i1 += 1) {
                        double __s16_n1__out_n2IN___tmp65;
                        {
                            double __in1 = __state->__0_ccol[((((J * K) * __i0) + (K * __i1)) + k)];
                            ...
                            __s16_n1__out_n2IN___tmp65 = __out;
                        }
                        {
                            const double __in2 = __s16_n1__out_n2IN___tmp65;
                            double __in1 = __state->__0_dcol[((((J * K) * __i0) + (K * __i1)) + k)];
                            double __out;
            ...
            dace::CopyNDDynamic<double, 1, false, 2>::Dynamic::Copy(
            __state->__0___tmp66, __state->__0_dcol + k, I, J, (J * K), J, 1, K);

            dace::CopyNDDynamic<double, 1, false, 2>::Dynamic::Copy(
            __state->__0_dcol + k, __state->__0_data_col, I, (J * K), J, J, K, 1);
            {
                #pragma omp parallel for
                for (auto __i0 = 0; __i0 < I; __i0 += 1) {
                    for (auto __i1 = 0; __i1 < J; __i1 += 1) {
                        double __s16_n11__out_n12IN___tmp67;
                        {
                            double __in1 = __state->__0_dcol[((((J * K) * __i0) + (K * __i1)) + k)];
                            double __in2 = u_pos[((((J * K) * __i0) + (K * __i1)) + k)];
                            double __out;
                            ...
                            __s16_n11__out_n12IN___tmp67 = __out;
                        }
                        {
                            const double __in2 = __s16_n11__out_n12IN___tmp67;
                            double __in1 = dtr_stage;
                            double __out;
...
DACE_EXPORTED auto_opt_t *__dace_init_auto_opt(long long I, long long J, long long K)
{
    ...
    __state->__0_dcol = new double DACE_ALIGN(64)[((I * J) * K)];
...
DACE_EXPORTED void __dace_exit_auto_opt(auto_opt_t *__state)
{
