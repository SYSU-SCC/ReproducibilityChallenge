...
void __program_bicg_internal(bicg_t *__state, double * __restrict__ A, double * __restrict__ o1, double * __restrict__ o2, double * __restrict__ p, double * __restrict__ r, int GM, int GN, int LMx, int LNy, int Px, int Py)
{

    {
        ...
        dace::CopyNDDynamic<double, 1, false, 1>::template ConstDst<1>::Copy(
        __state->__0___tmp5, o2, GM, 1);

    }
}

DACE_EXPORTED void __program_bicg(bicg_t *__state, double * __restrict__ A, double * __restrict__ o1, double * __restrict__ o2, double * __restrict__ p, double * __restrict__ r, int GM, int GN, int LMx, int LNy, int Px, int Py)
{
    __program_bicg_internal(__state, A, o1, o2, p, r, GM, GN, LMx, LNy, Px, Py);
}

DACE_EXPORTED bicg_t *__dace_init_bicg(int GM, int GN, int LMx, int LNy, int Px, int Py)
{
    int __result = 0;
    bicg_t *__state = new bicg_t;
    ...
    __state->__0___tmp2 = new double DACE_ALIGN(64)[GN];
    __state->__0___tmp3 = new int DACE_ALIGN(64)[2];
    __state->__0___tmp4 = new int DACE_ALIGN(64)[2];
    __state->__0___tmp5 = new double DACE_ALIGN(64)[GM];
...
DACE_EXPORTED void __dace_exit_bicg(bicg_t *__state)
{
